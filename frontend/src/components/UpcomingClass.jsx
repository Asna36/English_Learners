...
const UpcomingClass = () => {
    ...
    return (
        ...
        <div className="dashboard-page font-sassoon">
            <Sidebar activeLink="upcoming-class" /> 

            <main className="dashboard-main-content">
                
                <header className="dashboard-header">
                    <h1 className="header-title">My Upcoming Classes</h1>
                      ...
                      <br></br>
                        <div className="classes-grid">
                            ...
                            <div className="class-card statements">
                               <Link to="/quizthrees">    <img src={STATEMENTS_BG_IMG} alt="Statements activity background" className="class-card-bg" /></Link>
