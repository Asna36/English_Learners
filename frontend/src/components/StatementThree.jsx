 ...
 .group-icon {
  ...
  .circle-highlight {
        ...
        `
            ...
            <div className="header-text"><img src="/static/Statements.png" alt=""></img></div>

            <header className="quiz-header">
            
                <img src="/static/statframe.png" alt="Header Background" className="header-bg" />
                
            </header>

            <main className="quiz-content">
                <div className="image-row">
                    <img src="/static/tree_icon 2.png" alt="Tree" className="tree-img" />
                    <img src="/static/greenQ.png" alt="Underscore" className="underscore-img" />
                    <img src="/static/talking.gif" alt="Bear" className="bear-img" />
                </div>
